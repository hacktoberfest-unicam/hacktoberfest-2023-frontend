...
import ScreenSmall from "../images/background/code-coding.gif"
...
export default function Layout() {
  ...
  return (
    <div>
      <Box bgcolor="#040204" height="100vh" sx={{ display: { md: "none", xs: "flex" }, flexDirection: "column", alignItems: "center" }}>
        <Box bgcolor="#040204" height={26} display="flex" justifyContent="center" padding={2}>
          <TypewriterEffect
            textStyle={{
              fontWeight: 800,
              fontSize: 20,
            ...
            startDelay={100}
            text="Sorry, the screen is too small, use a laptop"
            typeSpeed={50}
            hideCursorAfterText={true}
          />
        </Box>
          <img src={ScreenSmall} alt="screenToSmall" width={500} />
      </Box>
      ...
      <Box
        ...
        minHeight="100vh"
        sx={{
          backgroundImage: `url(${BackgroundLaptop})`,
