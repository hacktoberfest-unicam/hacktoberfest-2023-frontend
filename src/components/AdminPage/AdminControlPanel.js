...
export default function AdminControlPanel() {
  ...
  const filteredData = LeaderboardData.leaderboard?.filter(
    (item) => !adminUsers.includes(item.user.github_username)
  );
  ...
  //   return (
  //     <>
  //       <MUIDataTable title={"Users List"} data={data} columns={columns} />
  //     </>
  //   );
